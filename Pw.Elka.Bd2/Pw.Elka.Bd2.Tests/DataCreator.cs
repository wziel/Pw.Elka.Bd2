...
namespace Pw.Elka.Bd2.Tests
{
    public static class DataCreator
    {
        ...
        public static List<T> GetRandomCollectionFromWithMaxCount<T>(IReadOnlyList<T> list, int maxCount)
        {
        ...
        public static Pozycja CreateRandomPozycja(IReadOnlyList<Dzial> dzials, IReadOnlyList<Seria> serias, IReadOnlyList<Typ> typs)
        {
            return new Pozycja()
            {
                ...
                Seria = Random.Next(100) < 30 ? null : GetRandomElementFrom(serias),
